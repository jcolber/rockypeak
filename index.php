...
<title>Rocky Peak Landscape, A Utah Landscape Company</title>
<meta name="description" content="Local Utah Landscaping Business">
    ...
    <nav id="menu" class="navbar navbar-default navbar-fixed-top">
      <div class="container"> 
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand page-scroll" href="#page-top" itemprop="name">Rocky Peak Landscape</a> </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-12 intro-text">
                <h1 itemprop="name">Landscaping Services</h1>
                <p itemprop="description">A local Utah Landscape company that offers year round services</p>
        ...
        <div class="row">
          <div class="col-xs-12 col-md-6">
            <div class="about-text">
              <h2>Welcome to <span itemprop="name">Rocky Peak Landscape</span></h2>
              <hr>
        ...
        <div class="col-md-10 col-md-offset-1 contact-info">
          ...
          <div class="col-md-4">
            ...
            <div class="contact-item">
              <p itemprop="telephone">Phone: <a href="tel: +1-801-598-9553">(801)598-9553</a></p>
              <p itemprop="email">Email: <a href="mailto: rockypeaklandscape@gmail.com">rockypeaklandscape@gmail.com</a></p>
            </div>
          </div>
        </div>
